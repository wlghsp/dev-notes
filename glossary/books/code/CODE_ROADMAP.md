...
- [x] code-concept.md — 코드란 무엇인가, 소통을 위한 기호 체계
- [x] morse-code.md — 모스 부호, 점/대시로 문자 표현
- [x] two-state-signal.md — 두 가지 상태만으로 정보를 전달할 수 있다

## Chapter 2 — Codes and Combinations

- [x] binary-combinations.md — 2ⁿ 공식, n개 자리에서 만들어지는 조합 수
- [x] powers-of-two.md — 2의 거듭제곱, 이진 시스템 어디서나 등장하는 이유
...
진행 방식: 챕터 순서대로. CSAPP과 병행하며 하드웨어 맥락 보충에 집중.
